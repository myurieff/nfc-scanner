...
extension MainView {
    ...
    func scanPassport( ) {
        ...
        let masterListURL = Bundle.main.url(forResource: "RDW", withExtension: ".crt")!
       ...
       // https://www.icao.int/publications/Documents/9303_p10_cons_en.pdf (page 50)
       // M - Manadatory O - Optional, C - Condtional
       //.DG1 - > MRZ(M), .DG2 - > BioMetric(M), .DG3 -> Fingers(O)
       //.DG4 -> Iris (O), .DG5 -> Portrait Image (O), .DG6 -> Reserved (O), .DG7 -> Displayed Signature (O), .DG8, .DG9, .DG10, .DG11 -> YTD, .DG12 -> Addtn. Documents(O),   .DG14 -> Security (O), .DG15 -> Active Authentication (C), .DG16 -> Emergency Info (O)
        
        //READ ID TAGS : [.DG1,.DG2,.SOD,.DG14,.DG15] Possible at current speed
        
        passportReader.readPassport(mrzKey: mrzKey,tags: [.DG1,.DG2,.SOD],  customDisplayMessage: { (displayMessage) in
